...
def equal():
    ...
    #Return buttons to the NORMAL state
    enable_buttons()
    
def enable_buttons():
    """ Enable all buttons in the calculator"""
...
inverse_button = tkinter.Button(button_frame, text="I/x", font=button_font, bg=light_green, command=inverse)
...
#Run the root's windows mainloop
root.mainloop()
