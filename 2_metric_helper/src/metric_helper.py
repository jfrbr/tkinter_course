...
metric_list = ["fento", "nano", "micro","mili","cent","deci", "base value","deca","hecto","kilo","mega","giga","tera","peta"]
...
convert_button = tkinter.Button(root, text="Convert",font=field_font, bg=bg_color, command=convert)
