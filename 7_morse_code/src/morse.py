...
def play():
    ...
    for value in text:
        if value == ".":
            playsound("/home/juan/dev/python/10-projects-python/7_morse_code/src/dot.mp3")
            root.after(100)
        elif value == "-":
            playsound("/home/juan/dev/python/10-projects-python/7_morse_code/src/dash.mp3")
            root.after(200)
        elif value == " ":
            root.after(300)
        elif value == "|":
...
def show_guide():
    ...
    morse = ImageTk.PhotoImage(Image.open("/home/juan/dev/python/10-projects-python/7_morse_code/src/morse_chart.JPG"))
